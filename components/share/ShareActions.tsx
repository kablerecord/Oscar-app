...
export function ShareActions({
  ...
  const handleShareAsImage = async () => {
    ...
    try {
      ...
      link.download = `osqr-${isDebate ? 'debate' : 'response'}-${Date.now()}.png`
      link.href = dataUrl
      link.click()
    } catch (err) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: isDebate ? 'AI Panel Discussion' : 'OSQR Response',
          text: content,
          url: 'https://tryosqr.app',
        })
      } catch (err) {
      ...
      >
        ...
        <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-neutral-200">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">tryosqr.app</p>
          </div>
        </div>
        ...
        <div className="mt-6 pt-4 border-t border-neutral-200 flex items-center justify-between">
          <span className="text-sm text-neutral-400">
            Generated with OSQR - Your AI Second Brain
          </span>
