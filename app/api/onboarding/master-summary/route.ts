...
`
    ...
    const summaryResponse = await gptProvider.generate({
      messages: [
        {
          role: 'system',
          content: `You are OSQR, creating a personalized "Master Summary" for a new user who just completed onboarding. This summary should make them feel understood and excited about what OSQR can do for them.

Your summary should:
1. Show that you "get" them and their situation
2. Connect their frustrations to how OSQR can help
3. Be warm, personal, and encouraging
4. Highlight 2-3 specific ways OSQR can help based on what you've learned
...
*— OSQR*`
    ...
    const suggestionsResponse = await gptProvider.generate({
      messages: [
        {
          role: 'system',
          content: `Based on the user's profile and onboarding journey, suggest 3 specific things they could do next with OSQR. Be specific and actionable, not generic. Each suggestion should be one sentence.
...
What are 3 specific things this user could do next with OSQR?`
        }
      ],
      temperature: 0.7,
    ...
    try {
      ...
      suggestions = [
        `Ask OSQR about your ${workingOn || 'project'} and get personalized insights`,
...
Whether it's brainstorming ideas, diving deep into your documents, or getting multiple perspectives on tough decisions - I've got your back. The more you use OSQR, the more personalized and helpful I become.

Let's build something great together.`,
      suggestions: [
        'Start a conversation about what you\'re working on',
        'Upload more documents to expand your knowledge base',
        'Ask OSQR to help you think through a current challenge'
      ],
      isFallback: true
    })
  }
